...
function AuraWatermark() {
  return (
    <div className="card-right-text gsap-reveal order-1 lg:order-3 flex flex-col items-center lg:items-end justify-center z-20 w-full select-none">
      ...
      <h2 
        className="text-6xl md:text-[6.5rem] lg:text-[8.5rem] font-black tracking-tighter text-transparent bg-clip-text animate-text-clip uppercase leading-none text-center lg:text-right"
        style={{
